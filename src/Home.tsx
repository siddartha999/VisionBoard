    ...
    return (
        <div id="Home" className="mt-16">
            <div id="home_components" className="grid grid-cols-1 lg:grid-cols-3 w-[80%] mx-auto gap-4 lg:gap-8">
                <div className="h-40 lg:h-80 bg-blue-700 cursor-pointer hover:bg-blue-800">
                ...
                <div className="h-40 lg:h-80 bg-orange-700 cursor-pointer hover:bg-orange-800">
                    <p className="text-2xl text-center pt-15 lg:pt-30">Day by Day</p>
                    <p className="text-lg text-center  mt-2">Log your daily activity</p>
                </div>
                <div className="h-40 lg:h-80 bg-green-700 cursor-pointer hover:bg-green-800">
